...
class BasePage:
    ...
    def go_to_basket(self):
        assert self.is_element_present(*BasePageLocators.BUTTON_BASKET), "Button basket is not presented"
        button_link = self.browser.find_element(*BasePageLocators.BUTTON_BASKET)
        button_link.click()
